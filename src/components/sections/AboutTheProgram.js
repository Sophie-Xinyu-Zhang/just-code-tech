...
const AboutTheProgram = ({
  ...
  const sectionHeader = {
    ...
    paragraph:
      `JustCode is a fast-paced 12-week cohort that helps you in your career seeking process.
              ...
              <div className='tiles-item-inner'>
                ...
                <div className='features-tiles-item-content'>
                  ...
                  <p className='m-0 text-sm'>
                    ...
                    hours long. In each lecture, we are going to cover common algorithmic
                    patterns that can be applicable to all interviews.
                  </p>
                </div>
              </div>
            </div>
