              ...
              <div className='tiles-item-inner'>
                <div className='testimonial-item-content'>
                  ...
                  <p className='text-sm mb-0'>
                    ...
                    really understands the interviewing process [...]
                    Justin has crafted a template of
                    "how to interview." I found myself reading over this guide
                    before my interviews [...] He has a good sense of character, technical
                    intellect and can detect where his clients are struggling
                    the most. If you have the opportunity to connect and work w/
                    Justin, you will find he gets the job done and more!
                  </p>
                </div>
                <div className='testimonial-item-footer text-xs mt-32 mb-0 has-top-divider'>
                  <span className='testimonial-item-name text-color-high'>
